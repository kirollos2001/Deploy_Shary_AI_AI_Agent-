...
def health_check():
    try:
        ...
        env_vars = {
            ...
            "DB_HOST": "set" if os.environ.get('DB_HOST') else "missing",
            "DB_USER": "set" if os.environ.get('DB_USER') else "missing",
            "DB_PASSWORD": "set" if os.environ.get('DB_PASSWORD') else "missing",
            "EMAIL_USER": "set" if os.environ.get('EMAIL_USER') else "missing",
